...
async def main():
    ...
    """
    start_time = time.perf_counter()
    fetch_tasks = [socks4.fetch_proxys_write_to_class(input_proxy_number,input_evaluation_rounds,data_size),
                   socks5.fetch_proxys_write_to_class(input_proxy_number,input_evaluation_rounds,data_size),
    ...
    evaluate_tasks = [socks4.evaluate_proxy_list(counter, input_evaluation_rounds,data_size, input_proxy_number),
                      socks5.evaluate_proxy_list(counter, input_evaluation_rounds,data_size, input_proxy_number),
    ...
    await socks4.print_proxy_list()
    await socks5.print_proxy_list()
    await http.print_proxy_list()
    await connect25.print_proxy_list()
